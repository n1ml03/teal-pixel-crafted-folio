              ...
              <div className="space-y-3 sm:space-y-4 pl-3 sm:pl-4 border-l-2 border-gray-100">
                <div className="mb-3 sm:mb-4">
                  ...
                  <div className="bg-blue-50 p-2 sm:p-3 rounded-md text-xs text-blue-700 mb-3 sm:mb-4">
                    ...
                    <p className="break-all text-[10px] sm:text-xs">https://example.com?<span className="font-bold">utm_source</span>=twitter&<span className="font-bold">utm_medium</span>=social&<span className="font-bold">utm_campaign</span>=summer_sale</p>
                  </div>
                </div>
                  ...
                  <div className="text-[10px] sm:text-xs font-mono bg-white p-1.5 sm:p-2 rounded border overflow-x-auto max-h-24 sm:max-h-32">
                    {form.watch('url') && (
                      <span className="text-gray-800">
                        ...
                        {form.watch('utmMedium') && (form.watch('utmSource') ? '&' : '') + <span className="text-blue-600">utm_medium={form.watch('utmMedium')}</span>}
                        {form.watch('utmCampaign') && ((form.watch('utmSource') || form.watch('utmMedium')) ? '&' : '') + <span className="text-purple-600">utm_campaign={form.watch('utmCampaign')}</span>}
                        {form.watch('utmTerm') && ((form.watch('utmSource') || form.watch('utmMedium') || form.watch('utmCampaign')) ? '&' : '') + <span className="text-orange-600">utm_term={form.watch('utmTerm')}</span>}
                        {form.watch('utmContent') && ((form.watch('utmSource') || form.watch('utmMedium') || form.watch('utmCampaign') || form.watch('utmTerm')) ? '&' : '') + <span className="text-red-600">utm_content={form.watch('utmContent')}</span>}
                      </span>
                    )}
                    {!form.watch('url') && (
