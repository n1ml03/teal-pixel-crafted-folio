          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 w-full md:w-auto">
            <div className="backdrop-blur-sm bg-white/50 px-5 py-4 rounded-lg shadow-sm">
              ...
              <ul className="space-y-2.5">
                ...
                <li>
                  <a href="/#services" className="text-gray-700 hover:text-teal-600 transition-colors flex items-center">
                    <Code className="w-4 h-4 mr-2" />
                    Services
                  </a>
                </li>
                <li>
                  <a href="/#projects" className="text-gray-700 hover:text-teal-600 transition-colors flex items-center">
            ...
            <div className="backdrop-blur-sm bg-white/50 px-5 py-4 rounded-lg shadow-sm">
              ...
              <ul className="space-y-2.5">
                <li>
                  <a href="/#experience" className="text-gray-700 hover:text-teal-600 transition-colors flex items-center">
                    <Briefcase className="w-4 h-4 mr-2" />
                    Experience
                  </a>
                </li>
                <li>
                  <a href="/#certifications" className="text-gray-700 hover:text-teal-600 transition-colors flex items-center">
