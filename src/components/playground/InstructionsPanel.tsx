...
export const InstructionsPanel = ({
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-background via-background to-muted/20 border-r border-border/50 backdrop-blur-sm">
      {/* Header with glassmorphism effect */}
      <div className="relative p-6 border-b border-border/50 bg-gradient-to-r from-background/80 to-muted/20 backdrop-blur-md">
        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center text-sm text-muted-foreground">
              <div className="flex items-center bg-muted/50 px-3 py-1.5 rounded-full border border-border/50">
      ...
      <ScrollArea className="flex-1 p-6">
        <div className="space-y-8">
          ...
          <div className="group">
            ...
            <div className="bg-gradient-to-br from-muted/30 to-muted/10 p-4 rounded-xl border border-border/50 group-hover:border-border transition-all duration-300">
          ...
          <div className="group">
            ...
            <div className="bg-gradient-to-br from-muted/20 to-background/50 p-4 rounded-xl border border-border/50 group-hover:border-border transition-all duration-300">
              <Progress 
                  ...
                  <li
                    ...
                    className={cn(
                      ...
                      objective.completed 
                        ...
                        : "bg-gradient-to-r from-background to-muted/20 border border-border/30 hover:border-border/60"
                    )}
      ...
      <div className="p-6 border-t border-border/50 mt-auto bg-gradient-to-r from-background/80 to-muted/20 backdrop-blur-md">
        <div className="grid grid-cols-2 gap-3 mb-3">
          ...
          <Button
            variant="outline"
            className="w-full group hover:bg-muted/50 hover:scale-105 transition-all duration-300 border-border/50"
            onClick={onReset}
          >
        ...
        {children && (
          <div className="mt-4 p-3 bg-gradient-to-r from-muted/30 to-background/50 rounded-lg border border-border/30">
            {children}
          </div>
        )}
      </div>
