      ...
      <SheetContent className="w-full sm:max-w-md md:max-w-lg overflow-y-auto bg-gradient-to-br from-background via-background to-muted/20 backdrop-blur-md">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <Input
                ...
                className="bg-background/50 border-border/50 focus:border-red-300 focus:ring-red-200 transition-all duration-200"
                aria-required="true"
              />
            </motion.div>
            ...
            >
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger 
                    id="bug-severity" 
                    className="bg-background/50 border-border/50 focus:border-red-300"
                  >
            ...
            >
              ...
              <Textarea
                ...
                className="bg-background/50 border-border/50 focus:border-red-300 focus:ring-red-200 transition-all duration-200 min-h-[100px] resize-none"
                aria-required="true"
              />
            </motion.div>
            ...
            >
              ...
              <Textarea
                ...
                className="bg-background/50 border-border/50 focus:border-red-300 focus:ring-red-200 transition-all duration-200 min-h-[80px] resize-none"
                aria-required="true"
              />
            </motion.div>
            ...
            >
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-background/50 border-border/50 focus:border-green-300 focus:ring-green-200 transition-all duration-200 min-h-[80px] resize-none"
                />
              </div>
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-muted/30 to-background/50 rounded-lg p-4 border border-border/50"
            >
          ...
          <motion.div
            ...
            className="flex flex-col-reverse sm:flex-row gap-3 mt-8 pt-6 border-t border-border/50"
          >
            <Button
              type="button"
              variant="outline"
              onClick={() => onOpenChange(false)}
              className="flex-1 border-border/50 hover:border-border hover:bg-muted/50 transition-all duration-200"
