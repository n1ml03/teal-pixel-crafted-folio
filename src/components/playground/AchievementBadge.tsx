...
export const AchievementBadge = memo(({
  ...
  const variantClasses = useMemo(() => {
    ...
    const variants = {
      ...
      elegant: 'bg-gradient-to-br from-white to-gray-50 border border-gray-200 text-gray-700 shadow-md hover:shadow-lg dark:from-gray-800 dark:to-gray-900 dark:border-gray-700 dark:text-gray-200'
    };
