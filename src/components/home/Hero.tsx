            ...
            >
              {[
                ...
                <MotionLink
                  ...
                  className={`w-12 h-12 rounded-xl bg-white/80 backdrop-blur-sm border border-gray-200 flex items-center justify-center text-gray-600 ${social.color} transition-all duration-200 shadow-sm hover:shadow-md`}
