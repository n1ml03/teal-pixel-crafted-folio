    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          <MotionButton
            onClick={scrollToTop}
            className="bg-white/90 backdrop-blur-sm text-gray-700 hover:text-teal-600 p-3 rounded-2xl border border-gray-200/50 shadow-lg"
                   ...
                   <div className="space-y-3">
                     {socialLinks.map((social, index) => (
                       ...
                       >
                         <MotionLink
                           href={social.href}
                           className={`flex items-center gap-3 bg-white/70 backdrop-blur-sm p-4 rounded-2xl text-gray-700 ${social.hoverColor} border border-gray-200/50 shadow-sm group transition-all duration-300`}
               ...
               <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                 ...
                 <div className="flex items-center gap-6 text-sm text-gray-500">
                   ...
                   <div className="hidden md:block">
                     <MotionButton
                       onClick={scrollToTop}
                       className="bg-white/90 backdrop-blur-sm text-gray-700 hover:text-teal-600 hover:bg-white p-2 rounded-xl border border-gray-200/50 shadow-sm"
