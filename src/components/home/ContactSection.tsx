                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    <motion.div className="space-y-3" variants={itemVariants}>
                      ...
                      <Input
                        ...
                        className="bg-white/90 backdrop-blur-md border-gray-200/50 rounded-2xl py-4 px-6 text-lg transition-all focus:border-teal-400 focus:ring focus:ring-teal-200/50 hover:bg-white"
                        required
                    ...
                    <motion.div className="space-y-3" variants={itemVariants}>
                      ...
                      <Textarea
                        ...
                        className="min-h-40 bg-white/90 backdrop-blur-md border-gray-200/50 rounded-2xl py-4 px-6 text-lg transition-all focus:border-teal-400 focus:ring focus:ring-teal-200/50 hover:bg-white resize-none"
                        required
