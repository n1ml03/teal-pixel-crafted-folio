...
const Sidebar = React.memo(({ navigate }: { navigate: (path: string) => void }) => (
  <div className="w-full lg:w-80 space-y-6">
    {/* Quick Links */}
    <Card className="bg-white/90 backdrop-blur-md border border-gray-200 shadow-md overflow-hidden">
          ...
          >
            ...
            <div className="relative mb-6">
              ...
              {showRecentSearches && recentSearches.length > 0 && (
                <div className="absolute z-10 mt-1 w-full bg-white rounded-lg shadow-lg border border-gray-200 py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 border border-blue-100 shadow-sm">
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        <Button
                          variant="outline"
                          size="sm"
                          className={`rounded-full text-xs ${searchCategory === null ? 'bg-blue-50 text-blue-700 border-blue-200' : 'bg-white text-gray-600 border-gray-200'}`}
                        ...
                        {matchCounts['getting-started'] > 0 && (
                          <Button
                            variant="outline"
                            size="sm"
                            className={`rounded-full text-xs ${searchCategory === 'getting-started' ? 'bg-blue-50 text-blue-700 border-blue-200' : 'bg-white text-gray-600 border-gray-200'}`}
                            onClick={() => {
                        ...
                        {matchCounts['testing-environment'] > 0 && (
                          <Button
                            variant="outline"
                            size="sm"
                            className={`rounded-full text-xs ${searchCategory === 'testing-environment' ? 'bg-teal-50 text-teal-700 border-teal-200' : 'bg-white text-gray-600 border-gray-200'}`}
                            onClick={() => {
                        ...
                        {matchCounts['bug-reporting'] > 0 && (
                          <Button
                            variant="outline"
                            size="sm"
                            className={`rounded-full text-xs ${searchCategory === 'bug-reporting' ? 'bg-purple-50 text-purple-700 border-purple-200' : 'bg-white text-gray-600 border-gray-200'}`}
                            onClick={() => {
                        ...
                        {matchCounts['faq'] > 0 && (
                          <Button
                            variant="outline"
                            size="sm"
                            className={`rounded-full text-xs ${searchCategory === 'faq' ? 'bg-amber-50 text-amber-700 border-amber-200' : 'bg-white text-gray-600 border-gray-200'}`}
                            onClick={() => {
