...
const Home = () => {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Global background with optimized loading */}
      {isLoaded ? <EnhancedBackground optimizeForLowPerformance={false} /> : (
        <div className="fixed top-0 left-0 right-0 bottom-0 -z-10 bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50"></div>
      )}
