              ...
              <Button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-full transition-all duration-300 ${
                  selectedCategory === category.id 
                    ...
                    : 'bg-white/90 border-gray-200 hover:border-teal-300 hover:bg-teal-50'
                }`}
              >
                {category.icon}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            {filteredTools.map((tool, index) => (
              <motion.div
                ...
                whileHover={{ y: -2 }}
              >
                <Card className="h-full bg-white/90 border-gray-200 hover:border-teal-300 transition-all duration-200 hover:shadow-lg group overflow-hidden">
